...
const SellerDashboard = () => {
  ...
  return (
    <div className="mt-14 flex bg-gray-100 min-h-screen">
      {/* Sidebar */}
      <SideNav />

      {/* Main Content */}
      <div className="flex-1 px-4 sm:px-6 md:pl-72 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
          {stats.map((stat, index) => (
            <div
              key={index}
              className={`p-6 rounded-lg shadow-md ${stat.color} flex items-center`}
            >
