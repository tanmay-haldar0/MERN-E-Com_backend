  ...
  useEffect(() => {
    ...
    const verifyAndFetch = async () => {
      ...
      try {
        ...
        // Step 2: Fetch order details using the Razorpay order ID
        const res = await axios.get(
          `${server}/payment/order-details?razorpay_order_id=${razorpay_order_id}`,
          { withCredentials: true }
        );
        setOrderDetails(res.data);
      } catch (error) {
        console.error("Verification or order fetch failed:", error);
      }
    };
    ...
    <div className="min-h-screen mt-16 bg-gray-100 flex flex-col items-center justify-start px-4 py-8">
      ...
      >
        ...
        <div className="text-center mb-4">
          <h1 className="text-3xl font-extrabold text-green-600 sm:text-2xl">
            ClassiCustom
          </h1>
