...
const ProductCard = ({
  ...
  return (
    <div
      className="relative rounded-lg p-2 sm:w-[180px] h-[240px] sm:h-[310px] w-[150px] bg-white shadow-md hover:shadow-2xl duration-200 transform hover:scale-105 transition-all ease-out flex flex-col justify-center cursor-pointer"
