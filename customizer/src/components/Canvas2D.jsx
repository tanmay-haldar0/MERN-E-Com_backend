...
const Canvas2D = forwardRef(
  ({ config, elements, setElements, selectedId, setSelectedId, onExposeRecenter }, parentRef) => {
    ...
    // Expose the stage to parent using ref
          ...
          <Layer>
            <Group
              clipFunc={(ctx) => {
                ...
                mask.cutouts?.forEach(({ x, y, width, height, cutoutRadius = 0 }) => {
